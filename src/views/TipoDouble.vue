<template >
    ...
    <barra-navegacion></barra-navegacion>
      ...
      <div class="container-sm">
        ...
        border="top"
      >
       <b> Tipo Primitivo Double</b><br>
  
        Altas, bajas y modificaciones de Datos Double
      </v-alert>
      ...
      <div class="shadow p-3 mb-2 bg-white rounded table-container text-sm container-sm" v-if="$store.state.permisos.includes(11) & !NoHayRegistros">
       ...
       <table :value="customers" class="table justify-center bg-blue darken-1 "    >
          <thead>
            <tr>
              <th ><v-chip class="justify-center primary">double_id</v-chip></th>
          ...
          <tbody v-for="Listaform of ListaFormularios" :key="Listaform.double_id">
            <tr>
              <td class="bg-white " >
                
                  <v-icon start icon="mdi-arrow-right" ></v-icon>  {{ Listaform.double_id }}
      ...
      <br><br><br>  
            ...
            <div class="row" >
              <div class="col  p-3 text-center ">
                <v-text-field  v-model="double_id" label="Ingresar double_id" variant="underlined"></v-text-field>
               </div>
              <div class="col  p-3 text-center">
  ...
  export default {
    ...
    methods: {
      ...
      editar(Listaform){
        ...
        this.Entrega = 1;
        this.dialog = true;
        this.double_id = Listaform.double_id;
      ...
      async fetch() {
        ...
        const respuesta = await this.axios.get("/api/ConfigForm/ListaCamposDoble?pTipo=1")
          .then((respuesta) => {
    ...
    this.idConfigFormToDelete = this.double_id; // Guarda el idConfigForm en data
      ...
      async Grabar() {
        ///alert("Agrega Campo");
          ...
          await this.axios.post(`/api/ConfigForm/AgregarCamposInteger/3/0/${this.default_value}/${this.value_list}/${this.min_configuration}/${this.min_value}/${this.max_configuration}/${this.max_value}/${this.assumed_value}`)
          .then(datos => {
            this.mostrarAlertaEliminar = false;
      ...
      async Modificar() {
          ...
          await this.axios.put(`/api/ConfigForm/ModificaCamposInteger/3/${this.double_id}/${this.default_value}/${this.value_list}/${this.min_configuration}/${this.min_value}/${this.max_configuration}/${this.max_value}/${this.assumed_value}`)
          .then(datos => {
            this.mostrarAlertaEliminar = false;
      ...
      async eliminarform(idConfigFormToDelete) {
        await this.axios.put(`/api/ConfigForm/EliminaCampos/3/${this.idConfigFormToDelete}`)
