<template >
    ...
    <barra-navegacion></barra-navegacion>
      ...
      <div class="container-sm">
        ...
        border="top"
      >
       <b> Tipo Primitivo DateTime</b><br>
  
       Altas, bajas y modificaciones de Datos DateTime
      </v-alert>
      ...
      <div class="shadow p-3 mb-2 bg-white rounded table-container text-sm container-sm" v-if="$store.state.permisos.includes(11) & !NoHayRegistros">
       ...
       <table :value="customers" class="table justify-center bg-blue darken-1 "  color="#006699"  >
          <thead>
            <tr>
              <th ><v-chip class="justify-center primary">datetime_id</v-chip></th>
          ...
          <tbody v-for="Listaform of ListaFormularios" :key="Listaform.datetime_id">
            <tr>
              <td class="bg-white " >
                
                  <v-icon start icon="mdi-arrow-right" ></v-icon>  {{ Listaform.datetime_id }}
      ...
      <v-form fast-fail @submit.prevent>
            ...
            <div class="row" >
              <div class="col  p-3 text-center ">
                <v-text-field  v-model="datetime_id" label="Ingresar datetime_id" variant="underlined"></v-text-field>
               </div>
              <div class="col  p-3 text-center">
            ...
            ></v-checkbox>
              ...
              <div class="col  p-3 text-center">
              <v-text-field :rules="[() => !!date_format || 'Ingresar datos']"  v-model="date_format" label="Ingresar date_format" variant="underlined"></v-text-field> 
              
          </div>
          <div class="col  p-3 text-center">
              <v-text-field type="date" v-model="value_list" label="Ingresar value_list" variant="underlined"></v-text-field>  
        ...
        <div class="row" >
          ...
          <div class="col  p-3 text-center">
            ...
            ></v-checkbox>  
              ...
              <div class="col  p-3 text-center">
                <v-text-field :rules="[() => !!time_format || 'Complete con datos']" v-model="time_format" label="Ingresar time_format" variant="underlined"></v-text-field>  
              </div>
              <div class="col  p-3 text-center">
                <v-text-field type="time"  v-model="upper_time" label="Ingresar upper_time" variant="underlined"></v-text-field>  
            ...
            <div class="row" >
                <div class="col  p-3 text-center">
              <v-text-field type="time"  v-model="lower_time"  label="Ingresar lower_time" variant="underlined"></v-text-field>  
              </div>
                <div class="col  p-3 text-center">
              <v-text-field type="date" v-model="lower_date"  label="Ingresar lower_date" variant="underlined"></v-text-field>  
              </div>
              <div class="col  p-3 text-center">
              <v-text-field :rules="[() => !!assume_value || 'Complete con datos']" v-model="assume_value"  label="Ingresar assume_value" variant="underlined"></v-text-field> 
              
              </div>
              <div class="col  p-3 text-center">
               
              <v-text-field  type="date" color="primary" v-model="upper_date"  label="Ingresar upper_date" variant="underlined"></v-text-field>  
          ...
          <v-btn  prepend-icon="mdi-cancel" color="#FF0000" v-on:click="mostrarConfirmacionEliminar(this.datetime_id)" >   <v-spacer></v-spacer> Anular</v-btn>
          </div>
          <!--alerta suceso-->
        </v-form>
 <div class="col  p-3 text-center">
  ...
  export default {
    ...
    methods: {
      ...
      editar(Listaform){
        ...
        //alert(Listaform.lower_date.substr(0, 10))
        //this.picker =  Listaform.lower_date.substr(0, 10);
        //alert(this.picker)
        this.Entrega = 1;
        this.dialog = true;
        this.datetime_id = Listaform.datetime_id;
        ...
        //this.value_list = Listaform.value_list.substr(0, 10);
        this.value_list = new Date(Listaform.value_list).toISOString().substring(0, 10);
      ...
      async fetch() {
        ...
        const respuesta = await this.axios.get("/api/ConfigForm/ListaCamposDateTime?pTipo=1")
          .then((respuesta) => {
    ...
    this.idConfigFormToDelete = this.datetime_id; // Guarda el idConfigForm en data
...
//alert(this.value_list);

//api/ConfigForm/AgregarCamposDateTime/1/0/true/true/1date_format%201/true/123/2024-02-01/true/true/2024-02-01/10%3A22/true/2024-02-01/10%3A22/hola
          
//await this.axios.post(`/api/ConfigForm/AgregarCamposDateTime/1/0/${this.enable_format}/${this.use_date_format}/${this.date_format}/${this.use_time_format}/${this.time_format}/${this.value_list}/${this.use_range}/${this.upper_bound}/${this.upper_date}/10%3A22/true/2024-02-01/10%3A22/hola`)

await this.axios.post(`/api/ConfigForm/AgregarCamposDateTime/1/0/${this.enable_format}/${this.use_date_format}/${this.date_format}/${this.use_time_format}/${this.time_format}/${this.value_list}/${this.use_range}/${this.upper_bound}/${this.upper_date}/${this.upper_time}/${this.lower_bound}/${this.lower_date}/${this.lower_time}/${this.assume_value}`)
      ...
      async Modificar() {
        ...
        await this.axios.put(`/api/ConfigForm/ModificarCamposDateTime/1/${this.datetime_id}/${this.enable_format}/${this.use_date_format}/${this.date_format}/${this.use_time_format}/${this.time_format}/${this.value_list}/${this.use_range}/${this.upper_bound}/${this.upper_date}/${this.upper_time}/${this.lower_bound}/${this.lower_date}/${this.lower_time}/${this.assume_value}`)
      ...
      async eliminarform(idConfigFormToDelete) {
        await this.axios.put(`/api/ConfigForm/EliminaCampos/9/${this.idConfigFormToDelete}`)
