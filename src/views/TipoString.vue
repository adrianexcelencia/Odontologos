<template >
    ...
    <barra-navegacion></barra-navegacion>
      ...
      <div class="container-sm">
        ...
        border="top"
      >
       <b> Tipo Primitivo String</b><br>
  
       Altas, bajas y modificaciones de Datos String
      </v-alert>
      ...
      <div class="shadow p-3 mb-2 bg-white rounded table-container text-sm container-sm" v-if="$store.state.permisos.includes(11) & !NoHayRegistros">
       ...
       <table :value="customers" class="table justify-center bg-blue darken-1 "  color="#006699"  >
          <thead>
            <tr>
              <th ><v-chip class="justify-center primary">string_id</v-chip></th>
              ...
              <th ><v-chip class="justify-center primary">mask_library</v-chip></th>
              <th ><v-chip class="justify-center primary">assumed_value</v-chip></th>
              <th ><v-chip class="justify-center primary">length</v-chip></th>
              <th  ><v-chip class="justify-center primary">Ver Datos</v-chip></th>
            </tr>
          </thead>
          <tbody v-for="Listaform of ListaFormularios" :key="Listaform.string_id">
            <tr>
              <td class="bg-white " >
                
                  <v-icon start icon="mdi-arrow-right" ></v-icon>  {{ Listaform.string_id }}
             
            </td>
              <td class="bg-white ">
                <v-chip class="justify-center bg-blue darken-1 sm"  color="#FFFFFF" elevation="4"   >
               <b> {{ Listaform.default_value }}</b>
              </v-chip>
              </td>
              <td  class="bg-white ">{{ Listaform.value_list }}</td>
              <td  class="bg-white ">{{ Listaform.mask_library }}</td>
              <td  class="bg-white ">{{ Listaform.assumed_value }}</td>
              <td  class="bg-white ">{{ Listaform.length }}</td>
      ...
      <v-form fast-fail @submit.prevent>
            ...
            <div class="row" >
              <div class="col  p-3 text-center ">
                <v-text-field  v-model="string_id" label="Ingresar string_id" variant="underlined"></v-text-field>
               </div>
              <div class="col  p-3 text-center">
        ...
        <div class="row" >
          <div class="col  p-3 text-center">
              <v-text-field v-model="mask_library" label="Ingresar mask_library" variant="underlined"></v-text-field> 
          ...
          <div class="col  p-3 text-center">
              <v-text-field v-model="length" :rules="lengthRules" label="Ingresar length" variant="underlined"></v-text-field>  
 ...
 <div class="col  p-3 text-center">
  ...
  export default {
    ...
    computed: {
          ...
          return item.default_value.toLowerCase().includes(this.buscar.toLowerCase());
