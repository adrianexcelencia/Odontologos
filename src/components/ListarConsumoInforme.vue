...
exportToExcel() {
   ...
   async fetchArticulosMed() {
     ...
     async GenerarInforme() {
      ...
      const respuesta = await this.axios.get(`/api/ConfigForm/ListarConsumoFiltrado?pFechaDesde=${fechaDesdeSinGuiones}&pFechaHasta=${fechaHastaSinGuiones}&Usuario=${this.idUsuario}&pInstitucion=${IdTipo}`)
